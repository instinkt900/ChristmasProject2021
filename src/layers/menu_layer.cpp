...
void MenuLayer::Draw(SDL_Renderer& renderer) {
    SDL_RenderCopy(&m_renderer, m_splashTexture, nullptr, nullptr);
    ...
    SDL_RenderCopy(&m_renderer, m_titleTextDrop, nullptr, &destRect1Drop);

    SDL_Rect destRect1{ text1X, text1Y, text1Width, text1Height };
    SDL_RenderCopy(&m_renderer, m_titleText, nullptr, &destRect1);

    SDL_Rect destRect2Drop{ text2X + 2, text2Y + 2, text2Width, text2Height };
    SDL_RenderCopy(&m_renderer, m_promptTextDrop, nullptr, &destRect2Drop);

    SDL_Rect destRect2{ text2X, text2Y, text2Width, text2Height };
    SDL_RenderCopy(&m_renderer, m_promptText, nullptr, &destRect2);
}
